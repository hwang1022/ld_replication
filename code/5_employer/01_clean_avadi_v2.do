...
*Purpose: Employers Survey Avadi V2 Cleaning
*Author: HW Jan 30 2025
*Last modified: HW Jan 30 2025
**************************************************	
**************************************************

	* This additional survey converts to V3
	
	use "$raw/ls_employers_survey_avadi_v2.dta" , clear
	drop if r4 == 0
	assert r4 == 1
...
****************
	...
	save "$temp/ls_employers_survey_avadi_v2_renamed.dta" , replace
