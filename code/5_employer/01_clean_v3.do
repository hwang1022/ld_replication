...
*Purpose: Employers Survey v3 Cleaning
*Author: HW Jan 24 2025
*Last modified: HW Jan 30 2025
**************************************************	
**************************************************
	
	use "$raw/ls_employers_survey_v3.dta" , clear
	drop if r4 == 0
	assert r4 == 1
...
**## Recruiter's Section > consent > Section B: Worker Skills
	...
	rename b13            rec_reg_work_inc_pdivity_earn
...
**## Recruiter's Section > consent > Section C: Multi-Day
	...
	rename c1_1      rec_current_how_many_from_stand
...
**## Employer Survey > Section k: Recruitment Purpose
	...
	rename k9            	em_10_worker_morethan_1day
	rename k10            	em_reg_work_inc_pdivity_earn
...
**## Employer Survey > Section C: Multi-Day
	...
	rename n1_1      em_current_how_many_from_stand
...
/*
	...
	foreach i in 	last_30days_laborstand_hire	day_min_hire_from_stand day_max_hire_from_stand 10day_contract_absent_days	///
					...
					same_workers same_workers_others_spec 10_worker_morethan_1day {
...
****************
	...
	save "$temp/ls_employers_survey_v3_renamed.dta" , replace
