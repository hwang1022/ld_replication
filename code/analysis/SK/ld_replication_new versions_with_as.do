...
/*** !!!! IMPORTANT: 
if predicting only using control, need to decide if we use distribution of LOO 
for control only, or treatment (line 122)
*/
	...
	* Last edited by HW on April 28 2026
	preserve
		...
		* Note: sw_sum, w_n =0 for treat=1 if prediction is only for treat=0 --> computation carries through
		...
		* Distribution of LOO
		...
		scalar pct_j_attend = r(p25) // take 25th percentile
		...
		**# Diag 0: LOO distribution by treatment
...
****	
	...
	* First calendar week of shock (stand-phase calweek)
...
****	
	* 3.2.1 Timing of first shock (calendar week)
	...
	* 3.2.2 Timing of first shock (Week in study)
