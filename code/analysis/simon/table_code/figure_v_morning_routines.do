...
graph export "$data/output/figures/bar_morning_activities_low_att.pdf", replace
graph export "$data/output/figures/figure_v_a.pdf", replace
...
graph export "$data/output/figures/bars_use_alarm.pdf", replace
graph export "$data/output/figures/figure_v_b.pdf", replace
