...
local shocks_altspec "$data/temp/shocks_dataset_originaldata_25_altspec.dta"
local shocks_original_20 "$data/temp/shocks_dataset_originaldata_20.dta"
local shocks_original_30 "$data/temp/shocks_dataset_originaldata_30.dta"
local shocks_baseline_25 "$data/temp/shocks_dataset_originaldata_25_baseline.dta"
local shocks_rolling_4 "$data/temp/shocks_dataset_originaldata_rolling_4.dta"
local shocks_rolling_7 "$data/temp/shocks_dataset_originaldata_rolling_7.dta"

local outdir "$data/output/tables"
local verified_tex "`outdir'/shocks_analysis_col_3_robustness_originaldata.tex"
local roman_alias "`outdir'/table_a_vii.tex"
