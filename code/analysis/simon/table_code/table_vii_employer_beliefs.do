...
local employer_activity_cleaned "$data/02. Cleaning Data/08. Others/02. Output/Employers Survey/employer_activity_mainstudy_cleaned.dta"

local outdir "$data/output/tables"
capture mkdir "$data/output"
capture mkdir "`outdir'"
local table_tex "`outdir'/table_vii_employer_beliefs.tex"
local alias_tex "`outdir'/table_vii.tex"
