...
/*----------------------------------------------------*/
	...
	use "./07. Data/3. Main Study 3.0/02. Cleaning Data/01. Screening/02. Output/01_screening_named.dta", clear
	format date %td
...
/*----------------------------------------------------*/
	...
	isid rid
	saveold "./07. Data/3. Main Study 3.0/02. Cleaning Data/01. Screening/02. Output/02_screening_cleaned.dta", replace
	...
	* Only keep completed surveys 
	...
	saveold "./07. Data/3. Main Study 3.0/02. Cleaning Data/01. Screening/02. Output/03_screening_completed_cleaned.dta", replace
