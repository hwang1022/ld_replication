...
/*----------------------------------------------------*/
	...
	use "./07. Data/3. Main Study 3.0/02. Cleaning Data/03. Baseline/02. Output/01_baseline_named.dta", clear
...
/*----------------------------------------------------*/
	...
	**** TEMP DROP!
	...
	replace spot_time = spot_time - tc(09:30) if interviewer == "23. Ananthan" & stand == 15
...
/*----------------------------------------------------*/
	...
	drop deviceid subscriberid devicephonenum username caseid text_audit duration note* starttime endtime stand_name_prefill
	...
	* isid pid date 
	...
	save "./07. Data/3. Main Study 3.0/02. Cleaning Data/03. Baseline/02. Output/02_baseline_cleaned.dta", replace
	...
	* Keep completed surveys and incomplete surveys conducted at the stand 
	...
	sort stand pid date 
	save "./07. Data/3. Main Study 3.0/02. Cleaning Data/03. Baseline/02. Output/03_baseline_completed_cleaned.dta", replace
