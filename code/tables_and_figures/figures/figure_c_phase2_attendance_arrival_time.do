...
graph export "$output/figures/comm_dist_attend_nadj_p2.pdf", replace
graph export "$output/figures/figure_c_a.pdf", replace
...
graph export "$output/figures/hist_arrival_time_by_treatment_p2_daily.pdf", replace
graph export "$output/figures/figure_c_b.pdf", replace
