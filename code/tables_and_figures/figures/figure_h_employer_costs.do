...
graph export "$output/figures/figure_h_a.pdf", replace
...
graph export "$output/figures/rec_wrkr_training_duration.pdf", replace
graph export "$output/figures/figure_h_b.pdf", replace
